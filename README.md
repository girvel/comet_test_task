...
- `3/scraper.py` это копия `2/main.py`; я реализовал батчинг только для вставки в БД -- в демонстрационных целях; для полностью эффективного использования RAM надо переписать скрапер
